...
class User(db.Model):
    ...
    openid = db.Column(db.String(64), nullable=False, default="", server_default="")
    ...
    # favor_songs = db.relationship("Song", backref=db.backref("favor_users", lazy="select"), lazy="select", secondary=FavorList)
